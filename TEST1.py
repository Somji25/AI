...
model = load_model('C:/Users/nawaphon/Documents/65050454/Hard Project/Detect_Hand/test.h5')

# กำหนดคลาสตัวอักษรที่โมเดลจะทำนาย
classes = ['พ่อ', 'โชคดี', 'เป็นห่วง', 'ไม่สบาย', 'เศร้า', 'เสียใจ', 'ชอบ', 'ขอความช่วยเหลือ', 'เข้าใจแล้ว', 'คิดถึง', 'หิว',
           'แม่', 'ขอบคุณ', 'รัก', 'ชอบ', 'มีความสุข', 'ดีใจ', 'ยิ้ม', 'สวย', 'ขอโทษ', 'ถ',
           'ท', 'ธ', 'น', 'บ', 'ป', 'ผ', 'ฝ', 'พ', 'ฟ', 'ภ',
           'ว', 'ศ', 'ษ', 'ส', 'ห', 'ฬ', 'อ', 'ฮ']
